...
任务：本题目将为选手提供文章数据，参赛选手基于给定的数据构建文章质量判别模型。所有文章质量类别为以下11种：“深度事件”、“人物专栏 ”、“行业解读”、“物品评测”、“作品分析”、“攻略文”、“科普知识文”、“情感解读”、“治愈系文章”、“推荐文”、“其他”。训练数据只包含前10种，不包含“其他”类别，且包含大量未标注数据。测试数据包含全部质量类别。
